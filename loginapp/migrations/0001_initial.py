    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employeeage', models.CharField(blank=True, max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('salesmanname', models.CharField(blank=True, max_length=100, null=True)),
                ('salesmancode', models.CharField(blank=True, max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(blank=True, choices=[('CONTRACTOR', 'contractor'), ('ADMIN', 'admin'), ('EXTERIORDESIGNER', 'exteriordesigner'), ('ARCHITECT', 'architect'), ('CLIENT', 'client'), ('HOMECONSTRUCTIONMANAGEMENT', 'homeconstructionmanagement')], max_length=30)),
                ('mobile_no', models.CharField(blank=True, max_length=30, null=True, verbose_name='Mobile number')),
                ('status', models.CharField(blank=True, default='REJECT', max_length=50)),
